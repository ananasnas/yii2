 ...
 * @property PersonsCars[] $personsCars
 * @property Schedules[] $schedules
 * @property Stories[] $stories
 * @property Stories[] $stories0
 * @property Stories[] $stories1
 */
class persons extends \yii\db\ActiveRecord 
{
    ...
    public function getCars(){
        return $this->hasMany(Cars::className(), ['ID_car' => 'Cars_ID_car'])->
        viaTable('persons_cars', ['Persons_ID_person' => 'ID_person']);
    }
    
    public static function getPersons($id)
    {
        return persons::find()->where(['Groups_ID_group' => $id]) ->all();     
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getPersonsCars()
    {
        return $this->hasMany(PersonsCars::className(), ['Persons_ID_person' => 'ID_person']);
    }
    ...
    {
        return $this->hasMany(Schedules::className(), ['Persons_ID_person' => 'ID_person']);
    }
    ...
    {
        return $this->hasMany(Stories::className(), ['Persons_ID_person_creator' => 'ID_person']);
    }
    ...
    {
        return $this->hasMany(Stories::className(), ['Persons_ID_person_del' => 'ID_person']);
    }
    ...
    {
        return $this->hasMany(Stories::className(), ['Persons_ID_person' => 'ID_person']);
    }
}
